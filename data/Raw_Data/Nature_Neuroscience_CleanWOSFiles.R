setwd("File path") # Change to your project folder path
...
journal_folders=c("journal_folder_name")
for(i in journal_folders){
  ...
  data.frame=data.frame %>% 
    select(PT,AU,AF,TI,SO,LA,DT,DE,ID,AB,C1,C3,RP,FU,CR,NR,TC,Z9,U1,U2,PU,PI,PA,SN,J9,JI,PD,PY,VL,BP,EP,DI,EA,PG,WC,WE,SC,GA,UT,PM,DA)
